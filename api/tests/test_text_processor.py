...
def test_split_by_voice_no_tags():
    ...
    assert segments == [("af_heart", "Just plain text.")]
...
def test_split_by_voice_leading_text_uses_default():
    ...
    assert segments == [
        ("af_heart", "Narrator opens."),
        ("af_bella", "Then Bella speaks."),
    ]
...
def test_split_by_voice_merges_repeated_voice():
    ...
    assert segments == [("af_bella", "One. Two.")]
...
def test_split_by_voice_accepts_combined_voices():
    ...
    assert segments == [("af_bella(2)+af_sky", "Mixed.")]
...
def test_split_by_voice_empty_text():
    ...
    assert split_by_voice("", "af_heart") == [("af_heart", "")]
